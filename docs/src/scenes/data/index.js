          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <TextField
                ...
                sx={{ gridColumn: "span 1" ,backgroundColor: "#f1f1f1"}}
              />
              <TextField
                fullWidth
                variant="filled"
              ...
              fullWidth
              variant="filled"
              label="number of business categories"
              onBlur={handleBlur}
              onChange={handleChange}
              value={values.number_of_bussiness_categories}
              name="number_of_business_categories"
              error={touched.number_of_bussiness_categories && !!errors.number_of_bussiness_categories}
              sx={{ gridColumn: "span 1",
                    // color: 'inherit', // Disable default text color styling
                    backgroundColor: 'inherit', // Disable default background color styling
                  }}
            >
...
const checkoutSchema = yup.object().shape({
  ...
  number_of_bussiness_categories: yup.string().required('Number of business categories is required'),
